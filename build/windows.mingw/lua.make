...
ifeq ($(config),release)
  ...
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -O3 -g -march=native -fno-strict-aliasing -Wno-multichar -Wno-format-security -x c++
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -O3 -g -march=native -fno-strict-aliasing -Wno-multichar -Wno-format-security -x c++
...
ifeq ($(config),debug)
  ...
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -g -fno-strict-aliasing -Wno-multichar -Wno-format-security -x c++
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -g -fno-strict-aliasing -Wno-multichar -Wno-format-security -x c++
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS +=
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS)
