...
ifeq ($(config),release)
  ...
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -O3 -g -fno-exceptions -fno-rtti -U_FORTIFY_SOURCE -march=native -fno-strict-aliasing -Wno-multichar -Wno-format-security
...
ifeq ($(config),debug)
  ...
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -g -fno-exceptions -fno-rtti -U_FORTIFY_SOURCE -fno-strict-aliasing -Wno-multichar -Wno-format-security
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS +=
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS)
