project "irrlicht"
    ...
    filter { "system:windows" }
        ...
        libdirs { "$(DXSDK_DIR)Lib/x86", "dxd9sdk/lib" }
        links { "imm32" }
    ...
    filter { "system:macosx" }
        files { "source/Irrlicht/MacOSX/*.mm" }

    filter { "system:macosx", "files:source/Irrlicht/Irrlicht.cpp" }
        buildoptions { "-ObjC++", "-std=c++98" }
    filter { "system:macosx", "files:source/Irrlicht/COpenGLDriver.cpp" }
        buildoptions { "-ObjC++", "-std=c++98" }
    filter { "system:macosx", "files:source/Irrlicht/MacOSX/AppDelegate.mm" }
        buildoptions { "-ObjC++", "-std=c++98" }
    filter { "system:macosx", "files:source/Irrlicht/MacOSX/CIrrDeviceMacOSX.mm" }
        buildoptions { "-ObjC++", "-std=c++98" }
    filter { "system:macosx", "files:source/Irrlicht/MacOSX/OSXClipboard.mm" }
        buildoptions { "-ObjC++", "-std=c++98" }
